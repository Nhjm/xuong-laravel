                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('theme/admins/velzon/assets/images/logo-sm.png') }}"
                                        alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('theme/admins/velzon/assets/images/logo-dark.png') }}"
                                        alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('theme/admins/velzon/assets/images/logo-light.png') }}"
                                        alt="" height="17">
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <img id="header-lang-img"
                                    src="{{ asset('theme/admins/velzon/assets/images/flags/us.svg') }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="{{ asset('theme/admins/velzon/assets/images/flags/us.svg') }}"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('theme/admins/velzon/assets/images/flags/ae.svg') }}"
                                        alt="user-image" class="me-2 rounded" height="18">
