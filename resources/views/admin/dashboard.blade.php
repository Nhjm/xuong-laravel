                ...
                <div class="card h-100 rounded-0">
                    <div class="card-body p-0">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                <img src="{{ asset('theme/admins/velzon/assets/images/products/img-8.png') }}"
                                                    alt="" class="img-fluid d-block" />
                                            </a>
                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                <img src="{{ asset('theme/admins/velzon/assets/images/products/img-2.png') }}"
                                            ...
                                            <a href="apps-ecommerce-product-details.html" class="bg-light rounded p-1">
                                                <img src="{{ asset('theme/admins/velzon/assets/images/products/img-10.png') }}"
                                                    alt="" class="img-fluid d-block" />
                                            </a>
                                        </div>
                        ...
                        <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                            <div class="card-body">
                                <img src="{{ asset('theme/admins/velzon/assets/images/giftbox.png') }}" alt="">
                                <div class="mt-4">
